...
ent_imagen_red = "C:/Users/Jose/Downloads/JOSE/jose/Electronica/VIII Semestre/Seminario modalidad de grado/proyecto_frutas/green_bananas_pru/eba"
...
for nombre_imagen in nombre_imagenes:
    ...
    imagen = cv2.resize(imagen, (18,18), interpolation=cv2.INTER_CUBIC)
